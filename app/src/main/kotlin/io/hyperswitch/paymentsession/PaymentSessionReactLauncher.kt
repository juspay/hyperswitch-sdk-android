...
import io.hyperswitch.paymentsession.DefaultPaymentSessionLauncher.Companion.sessionToken
...
class PaymentSessionReactLauncher(private val activity: Activity) : SDKInterface {
    ...
    override fun presentSheet(
        ...
        val bundle = launchOptions.getBundle(sessionToken, configuration)
