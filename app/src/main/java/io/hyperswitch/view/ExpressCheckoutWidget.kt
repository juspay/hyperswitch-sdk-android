 ...
 * [ExpressCheckoutWidget] is instantiated.
 *
 *
 ...
 */
class ExpressCheckoutWidget : FrameLayout {
    ...
    private fun initView(context: Context) {
        ...
        Utils.openReactView(context as AppCompatActivity, emptyMap(), "expressCheckout", id)
    }
