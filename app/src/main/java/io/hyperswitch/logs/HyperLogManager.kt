...
object HyperLogManager {
    ...
    private const val DEFAULT_DELAY_IN_MILLIS = 10000L
    ...
    private fun debouncedPushLogs() {
        Debouncer(delayInMillis).debounce {
            sendLogsOverNetwork()
        }
    }

    fun initialise(context: Context, publishableKey: String, delayInMillis: Long = DEFAULT_DELAY_IN_MILLIS) {
