...
class PaymentSheet internal constructor(private val paymentSheetLauncher: PaymentSheetLauncher) {
    ...
    /**
     * Present the payment sheet to process a [PaymentIntent]. If the [PaymentIntent] is already
    ...
    @JvmOverloads
    fun presentWithPaymentIntentAndParams(map: Map<String, Any?>, sheetType: String? = null) {
    ...
    /**
     * Present the payment sheet to process a [SetupIntent]. If the [SetupIntent] is already
     * confirmed, [PaymentSheetResultCallback] will be invoked with [PaymentSheetResult.Completed].
     *
    ...
    constructor(
            ...
            /**
             * If set, the customer can select a previously saved payment method within
             * PaymentSheet.
             */
             ...
             * form fields with the values provided. This is used to display a "Billing address is
             * same as shipping" checkbox if `defaultBillingDetails` is not provided. If `name` and
             * `line1` are populated, it's also
             * [attached to the PaymentIntent](https://docs.hyperswitch.io//api/payment_intents/object#payment_intent_object-shipping)
             * during payment.
             */
             ...
             * Defaults to false.
             *
             * Some payment methods can't guarantee you will receive funds from your customer at the
             * end of the checkout because they take time to settle (eg. most bank debits, like SEPA
             * or ACH) or require customer action to complete (e.g. OXXO, Konbini, Boleto). If this
             * is set to true, make sure your integration listens to webhooks for notifications on
             * whether a payment has succeeded or not.
             *
             * See
             * [payment-notification](https://docs.hyperswitch.io//payments/payment-methods#payment-notification)
             * .
             */
             ...
             *
             * **Note**: PaymentSheet considers this property `true` if `shipping` details are
             * present on the PaymentIntent when PaymentSheet loads.
             */
        ...
        class Builder(private var merchantDisplayName: String) {
            ...
            fun customer(customer: CustomerConfiguration?) = apply { this.customer = customer }

            fun googlePay(googlePay: GooglePayConfiguration?) = apply { this.googlePay = googlePay }
            ...
            fun displaySavedPaymentMethods(displaySavedPaymentMethods: Boolean) = apply {
                this.displaySavedPaymentMethods = displaySavedPaymentMethods
            }

            fun placeHolder(placeHolder: PlaceHolder?) = apply { this.placeHolder = placeHolder }
            ...
            fun appearance(appearance: Appearance) = apply { this.appearance = appearance }

            fun primaryButtonLabel(primaryButtonLabel: String) = apply {
                this.primaryButtonLabel = primaryButtonLabel
            }

            fun themes(themes: String) = apply { this.themes = themes }

            fun disableBranding(disableBranding: Boolean) = apply {
                this.disableBranding = disableBranding
            }

            fun defaultView(defaultView: Boolean) = apply { this.defaultView = defaultView }

            fun paymentSheetHeaderLabel(paymentSheetHeaderLabel: String) = apply {
                this.paymentSheetHeaderLabel = paymentSheetHeaderLabel
            }

            fun savedPaymentSheetHeaderLabel(savedPaymentSheetHeaderLabel: String) = apply {
        ...
        fun getMap(): Map<String, Any?> {
            return mapOf(
                    ...
                    "allowsPaymentMethodsRequiringShippingAddress" to
                            allowsPaymentMethodsRequiringShippingAddress
            )
        }
    }
    ...
    data class Colors(
        ...
        class Builder() {
            ...
            fun primary(primary: Int?) = apply { this.primary = primary }

            fun surface(surface: Int?) = apply { this.surface = surface }

            fun component(component: Int?) = apply { this.component = component }

            fun componentBorder(componentBorder: Int?) = apply {
                this.componentBorder = componentBorder
            }

            fun componentDivider(componentDivider: Int?) = apply {
                this.componentDivider = componentDivider
            }

            fun onComponent(onComponent: Int?) = apply { this.onComponent = onComponent }

            fun onSurface(onSurface: Int?) = apply { this.onSurface = onSurface }

            fun subtitle(subtitle: Int?) = apply { this.subtitle = subtitle }

            fun placeholderText(placeholderText: Int?) = apply {
                this.placeholderText = placeholderText
            }

            fun appBarIcon(appBarIcon: Int?) = apply { this.appBarIcon = appBarIcon }
    ...
    data class Shadow(
        ...
        constructor(
                color: Color?,
                intensity: Float?
        ) : this(color = color?.toArgb(), intensity = intensity)

        fun getMap(): Map<String, Any?> {
            return mapOf("color" to getRGBAHex(color), "intensity" to intensity)
        }
    }
    ...
    data class Shapes(
            /**
             * The corner radius used for tabs, inputs, buttons, and other components in
             * PaymentSheet.
             */
    ...
    data class Typography(
            /**
             * The scale factor for all fonts in PaymentSheet, the default value is 1.0. When this
             * value increases fonts will increase in size and decrease when this value is lowered.
             */
        ...
        fun getMap(): Map<String, Any?> {
            return mapOf(
                    ...
                    "fontResId" to
                            fontResId?.let {
                                context.resources.getResourceName(it).toString().split("/")[1]
                            }
            )
        }
    }
    ...
    data class PrimaryButtonColors(
            /**
             * The background color of the primary button. Note: If 'null', {@link Colors#primary}
             * is used.
             */
    ...
    data class PrimaryButtonShape(
            /**
             * The corner radius of the primary button. Note: If 'null', {@link
             * Shapes#cornerRadiusDp} is used.
             */
            val cornerRadiusDp: Float? = null,
            /**
             * The border width of the primary button. Note: If 'null', {@link
             * Shapes#borderStrokeWidthDp} is used.
             */
            val borderStrokeWidthDp: Float? = null,
            /**
             * The shadow of the primary button. Note: If 'null', {@link Shapes#borderStrokeWidthDp}
             * is used.
             */
    ...
    data class PrimaryButtonTypography(
            /**
             * The font used in the primary button. Note: If 'null', Appearance.Typography.fontResId
             * is used.
             */
            @FontRes val fontResId: Int? = null,

            /**
             * The font size in the primary button. Note: If 'null', {@link
             * Typography#sizeScaleFactor} is used.
             */
            val fontSizeSp: Float? = null
    ) : Parcelable {
        fun getMap(): Map<String, Any?> {
            return mapOf("fontSizeSp" to fontSizeSp, "fontResId" to fontResId.toString())
        }
    }
    ...
    data class Address(
            /**
             * City, district, suburb, town, or village. The value set is displayed in the payment
             * sheet as-is. Depending on the payment method, the customer may be required to edit
             * this value.
             */
            ...
            /**
             * Address line 1 (e.g., street, PO Box, or company name). The value set is displayed in
             * the payment sheet as-is. Depending on the payment method, the customer may be
             * required to edit this value.
             */
            val line1: String? = null,
            /**
             * Address line 2 (e.g., apartment, suite, unit, or building). The value set is
             * displayed in the payment sheet as-is. Depending on the payment method, the customer
             * may be required to edit this value.
             */
            val line2: String? = null,
            /**
             * ZIP or postal code. The value set is displayed in the payment sheet as-is. Depending
             * on the payment method, the customer may be required to edit this value.
             */
            val postalCode: String? = null,
            /**
             * State, county, province, or region. The value set is displayed in the payment sheet
             * as-is. Depending on the payment method, the customer may be required to edit this
             * value.
             */
    ...
    data class BillingDetails(
            ...
            /**
             * The customer's email. The value set is displayed in the payment sheet as-is.
             * Depending on the payment method, the customer may be required to edit this value.
             */
            val email: String? = null,
            /**
             * The customer's full name. The value set is displayed in the payment sheet as-is.
             * Depending on the payment method, the customer may be required to edit this value.
             */
        ...
        class Builder {
            ...
            fun address(addressBuilder: Address.Builder) = apply {
    ...
    data class CustomerConfiguration(
            /**
             * The identifier of the Hyperswitch Customer object. See
             * [Hyperswitch's documentation](https://docs.hyperswitch.io//api/customers/object#customer_object-id)
             * .
             */
            val id: String,
        ...
        fun getMap(): Map<String, Any?> {
            return mapOf("id" to id, "ephemeralKeySecret" to ephemeralKeySecret)
        }
    }
    ...
    data class GooglePayConfiguration(
            ...
            /**
             * The two-letter ISO 3166 code of the country of your business, e.g. "US". See your
             * account's country value [here](https://app.hyperswitch.io/settings/account).
             */
            val countryCode: String,
            /**
             * The three-letter ISO 4217 alphabetic currency code, e.g. "USD" or "EUR". Required in
             * order to support Google Pay when processing a Setup Intent.
             */
    ...
    data class PlaceHolder(
        ...
        fun getMap(): Map<String, Any?> {
            return mapOf("cardNumber" to cardNumber, "expiryDate" to expiryDate, "cvv" to cvv)
        }
    }
    ...
    interface FlowController {
        ...
        /**
         * Retrieve information about the customer's desired payment option. You can use this to
         * e.g. display the payment option in your UI.
         */
        fun getPaymentOption(): PaymentOption?

        /**
         * Present a sheet where the customer chooses how to pay, either by selecting an existing
         * payment method or adding a new one. Call this when your "Select a payment method" button
         * is tapped.
         */
        ...
        companion object {
            ...
            fun create(
                ...
                return FlowControllerFactory(activity, paymentOptionCallback, paymentResultCallback)
                        .create()
            }
             ...
             *
             * @param fragment the Fragment that is presenting the payment sheet.
             * @param paymentOptionCallback called when the customer's [PaymentOption] selection
             * changes.
    ...
    companion object {
         ...
         *
         * You must call this method when the user logs out from your app. This will ensure that any
         * persisted authentication state in PaymentSheet, such as authentication cookies, is also
