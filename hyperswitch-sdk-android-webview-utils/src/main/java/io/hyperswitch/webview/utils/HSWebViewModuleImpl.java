...
public class HSWebViewModuleImpl {
    ...
    public HSWebViewModuleImpl(Context context) {
        mContext = context;
...
//        switch (requestCode) {
//            case HSWebViewModuleImpl.PICKER:
...
//                }
//                break;
//            case HSWebViewModuleImpl.PICKER_LEGACY:
//                if (resultCode != RESULT_OK) {
...
//        } else {
//            Log.w("HSWebViewModule", "there is no Activity to handle this Intent");
//        }
    }
...
//            }
//        } else {
//            Log.w("HSWebViewModule", "there is no Camera permission");
//        }
    ...
    public void downloadFile(String downloadingMessage) {
        ...
        try {
            ...
            Log.w("HSWebViewModule", "Unsupported URI, aborting download", e);
            return;
        }
