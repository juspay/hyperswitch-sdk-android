...
class MainActivity : AppCompatActivity(), HyperInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<EditText>(R.id.payloadInput).apply {
            ...
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable?) {
                    payloadString = s.toString()
                }
            })
        }
        findViewById<EditText>(R.id.publishable_key).apply {
            setText(publishableKey)
            addTextChangedListener(object : TextWatcher {
                override fun beforeTextChanged(
                    s: CharSequence?,
                    start: Int,
                ...
                override fun afterTextChanged(s: Editable?) {
                    publishableKey = s.toString()
                }
            })
        }
        findViewById<EditText>(R.id.api_key_input).apply {
            setText(apiKey)
            addTextChangedListener(object : TextWatcher {
                override fun beforeTextChanged(
                    s: CharSequence?,
    ...
    private fun fetchPaymentIntent() {
        ...
        Log.i("Manideep", payloadString)
        reset().post("$serverUrl/payments").header(
            ...
            .responseString(object : Handler<String?> {
                override fun success(value: String?) {
                    try {
                        ...
                        val sdkAuthorization = json.getString("sdk_authorization")
    ...
    companion object {
        ...
        private const val DEFAULT_SERVER_URL = "https://app.hyperswitch.io/api"
    }
}
