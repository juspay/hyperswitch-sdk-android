...
import io.hyperswitch.lite.payments.expresscheckoutlauncher.ExpressCheckoutPaymentMethodLauncher
import io.hyperswitch.lite.payments.googlepaylauncher.GooglePayEnvironment
import io.hyperswitch.lite.payments.googlepaylauncher.GooglePayLauncher
import io.hyperswitch.lite.payments.googlepaylauncher.GooglePayPaymentMethodLauncher
import io.hyperswitch.lite.payments.googlepaylauncher.PaymentMethod
import io.hyperswitch.lite.payments.paypallauncher.PayPalPaymentMethodLauncher
        ...
        fun onPaypalPaymentResultCallBack(paymentResult: String) {
            ...
            when (val status = jsonObject.getString("status")) {
                ...
                "failed", "requires_payment_method" -> {
                    ...
                    PayPalPaymentMethodLauncher.Result.Completed(io.hyperswitch.lite.payments.paypallauncher.PaymentMethod(status, 0, null)))
            }
        }
        ...
        fun onExpressCheckoutPaymentResultCallBack(paymentResult: String) {
            ...
            when (val status = jsonObject.getString("status")) {
                ...
                "failed", "requires_payment_method" -> {
                    ...
                    ExpressCheckoutPaymentMethodLauncher.Result.Completed(io.hyperswitch.lite.payments.expresscheckoutlauncher.PaymentMethod(status, 0, null)))
            }
        }
    }
