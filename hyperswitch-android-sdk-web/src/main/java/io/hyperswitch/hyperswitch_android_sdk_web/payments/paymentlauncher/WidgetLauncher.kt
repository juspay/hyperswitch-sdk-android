...
import io.hyperswitch.hyperswitch_android_sdk_web.payments.expresscheckoutlauncher.ExpressCheckoutPaymentMethodLauncher
import io.hyperswitch.hyperswitch_android_sdk_web.payments.googlepaylauncher.GooglePayEnvironment
import io.hyperswitch.hyperswitch_android_sdk_web.payments.googlepaylauncher.GooglePayLauncher
import io.hyperswitch.hyperswitch_android_sdk_web.payments.googlepaylauncher.GooglePayPaymentMethodLauncher
import io.hyperswitch.hyperswitch_android_sdk_web.payments.googlepaylauncher.PaymentMethod
import io.hyperswitch.hyperswitch_android_sdk_web.payments.paypallauncher.PayPalPaymentMethodLauncher
        ...
        fun onPaypalPaymentResultCallBack(paymentResult: String) {
            ...
            when (val status = jsonObject.getString("status")) {
                ...
                "failed", "requires_payment_method" -> {
                    ...
                    PayPalPaymentMethodLauncher.Result.Completed(io.hyperswitch.hyperswitch_android_sdk_web.payments.paypallauncher.PaymentMethod(status, 0, null)))
            }
        }
        ...
        fun onExpressCheckoutPaymentResultCallBack(paymentResult: String) {
            ...
            when (val status = jsonObject.getString("status")) {
                ...
                "failed", "requires_payment_method" -> {
                    ...
                    ExpressCheckoutPaymentMethodLauncher.Result.Completed(io.hyperswitch.hyperswitch_android_sdk_web.payments.expresscheckoutlauncher.PaymentMethod(status, 0, null)))
            }
        }
    }
